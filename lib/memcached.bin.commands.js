...
var MemcachedCommand = function () {};
	...
	MemcachedCommand.prototype.rawCommandLength = 0;
	MemcachedCommand.prototype.checkCommandOpcode = function (commandOpcode) {
	...
	MemcachedCommand.prototype.calcRawCommandLength = function (request) {
		this.rawCommandLength = request.headerSize + request.getTotalBody();
	};
...
function MemcachedNoopCommand () {
	...
	this.processData = function (memcached) {
		...
		this.calcRawCommandLength(request);
